...
export default function QuoteList() {
    ...
    const fetchContracts = async () => {
      try {
        ...
        const sortedContracts = response.data.sort(
          (a, b) => new Date(b.createdAt) - new Date(a.createdAt) // Sort descending by createdAt
        );
        setContracts(sortedContracts);
        setFilteredContracts(sortedContracts); // Initially, show all contracts
      } catch (error) {
  ...
  return (
   ...
   <>
   <AdminDashboard/> <div className="container mx-auto">
